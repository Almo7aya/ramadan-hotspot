...
// new edit Ali Almohaya 

HijriJS.getNowDateWithPrefix = function () {
	
	var _nowDate = this.today().toString().split("/");
	var _realDate = new Date();
	var _dayWeek = _realDate.getDay();
	// get the day and month and the year
	_nowDate[2] = _nowDate[2].split("").splice(0,4).join("");
	...
	return wdNames[_dayWeek] + ' , ' + _nowDate[0] + " " + iMonthNames[ Number.parseInt( _nowDate[1] )-1] + " " + _nowDate[2] + " هجرية ";
	
};

function writeIslamicDate() {
	
	return HijriJS.getNowDateWithPrefix();
